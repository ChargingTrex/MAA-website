...
// ✅ Hero / above-the-fold images (don't lazy-load)
<img src={heroUrl} alt="..." loading="eager" />

// ❌ Never
<img src={url} />                       // missing alt and loading
<img src={url} alt="" />               // empty alt on meaningful image
<img src={url} style={{width:'100%'}}  // inline styles
```
